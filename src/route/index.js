...
var header = {
  ...
  salary: '600$/month',
  address: 'Narnia, Hogwarts 9/14 St.',
}
var footer = {
  social: {
    email: {
      text: 'valeriia@mail.com',
      href: 'mailto:valeriia@mail.com',
    },
    phone: {
      text: '+380670000123',
          ...
          projects: [
            {
              ...
              about:
                'No idea what to write here so let it be some nonsense',
              stackAmount: 3,
              stacks: [
                {
                  name: 'React.js',
              ...
              awards: [
                {
                  name: 'Background verification - bla bla bla bla bla bla',
                },
                {
